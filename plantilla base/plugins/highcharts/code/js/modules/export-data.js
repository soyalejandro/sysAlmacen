    ...
    (function(a) {
                ...
                c(this.series, function(b) {
                    ...
                    if (!1 !== b.options.includeInCSVExport && !b.options.isInternal && !1 !== b.visible) {
                        ...
                        c(b.options.data, function(a, f) {
                            ...
                            r[a].x = l.x;
                            r[a].name = c;
                            for (r[a].xValues[y] = l.x; t < k;) f = d[t], c = l[f], r[a][w + t] = m(n[f][c], e[f] ? g.dateFormat(h.dateFormat, c) : null, c), t++
                        });
                        w += t
                    }
                });
                for (n in r) r.hasOwnProperty(n) && e.push(r[n]);
                var x, y;
                n = f ? [D, v] : [v];
                for (w = B.length; w--;) x = B[w][0],
                    y = B[w][1], d = l[x], e.sort(function(b, a) {
                        return b.xValues[x] - a.xValues[x]
                    }), k = E(d), n[0].splice(y, 0, k), f && n[1] && n[1].splice(y, 0, k), c(e, function(b) {
                        var a = b.name;
        ...
        a.Chart.prototype.getCSV = function(a) {
            var f = "",
                ...
                l =
                m(d.decimalPoint, "," !== d.itemDelimiter && a ? (1.1).toLocaleString()[1] : "."),
        ...
        a.Chart.prototype.getTable = function(a) {
            ...
            !1 !== h.exporting.tableCaption && (f += '\x3ccaption class\x3d"highcharts-table-caption"\x3e' + m(h.exporting.tableCaption, h.title.text ? h.title.text.replace(/&/g, "\x26amp;").replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;").replace(/"/g, "\x26quot;").replace(/'/g,
                "\x26#x27;").replace(/\//g, "\x26#x2F;") : "Chart") + "\x3c/caption\x3e");
            ...
            f += function(a, d, c) {
                ...
                if (b) {
                    for (f += "\x3ctr\x3e"; e < c; ++e) b = a[e], k = a[e + 1], b === k ? ++g : g ? (f += q("th", "highcharts-table-topheading", 'scope\x3d"col" colspan\x3d"' + (g + 1) + '"', b), g = 0) : (b === d[e] ? h.exporting.useRowspanHeaders ? (k =
                        2, delete d[e]) : (k = 1, d[e] = "") : k = 1, f += q("th", "highcharts-table-topheading", 'scope\x3d"col"' + (1 < k ? ' valign\x3d"top" rowspan\x3d"' + k + '"' : ""), b));
                    f += "\x3c/tr\x3e"
                }
                if (d) {
                    f += "\x3ctr\x3e";
